<?php
	...
	if($vw_life_coach_third_color != false){
		$vw_life_coach_custom_css .='.inner-box i, #footer .textwidget a,#footer li a:hover,.post-main-box:hover h3 a,#sidebar ul li a:hover,.post-navigation a:hover .post-title, .post-navigation a:focus .post-title,.post-navigation a:hover,.post-navigation a:focus,a, .post-main-box:hover h2 a,.post-main-box:hover .post-info a, .post-info:hover a, .inner-box:hover h4 a, .middle-bar p a:hover{
	...
	if($vw_life_coach_fourth_color != false){
		$vw_life_coach_custom_css .='.main-navigation ul.sub-menu a:hover, .woocommerce ul.products li.product .price,.woocommerce div.product p.price, .woocommerce div.product span.price, a.doc_btn i, nav.woocommerce-MyAccount-navigation ul li a:hover{
	...
	$vw_life_coach_resp_slider = get_theme_mod( 'vw_life_coach_resp_slider_hide_show',false);
	if($vw_life_coach_resp_slider == true && get_theme_mod( 'vw_life_coach_slider_arrows', false) == false){
    	$vw_life_coach_custom_css .='#slider{';
	...
	$vw_life_coach_resp_scroll_top = get_theme_mod( 'vw_life_coach_resp_scroll_top_hide_show',true);
	if($vw_life_coach_resp_scroll_top == true && get_theme_mod( 'vw_life_coach_footer_scroll',true) != true){
    	$vw_life_coach_custom_css .='.scrollup i{';
			$vw_life_coach_custom_css .='visibility:hidden !important;';
		$vw_life_coach_custom_css .='} ';
	}
    if($vw_life_coach_resp_scroll_top == true){
    	$vw_life_coach_custom_css .='@media screen and (max-width:575px) {';
		$vw_life_coach_custom_css .='.scrollup i{';
			$vw_life_coach_custom_css .='visibility:visible !important;';
		$vw_life_coach_custom_css .='} }';
