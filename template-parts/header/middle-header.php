    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-3">
        <?php if( get_theme_mod('vw_life_coach_email_text') != '' || get_theme_mod('vw_life_coach_email_address') != ''){ ?>
          <p class="py-2 py-lg-3 py-md-3 mb-0"><i class="far fa-envelope mr-2"></i><?php echo esc_html(get_theme_mod('vw_life_coach_email_text',''));?>: <a href="mailto:<?php echo esc_html(get_theme_mod('vw_life_coach_email_address',''));?>"><?php echo esc_html(get_theme_mod('vw_life_coach_email_address',''));?></a></p>
        <?php } ?>
      </div>
      <div class="col-lg-2 col-md-2">
        <?php if( get_theme_mod('vw_life_coach_phone_text') != '' || get_theme_mod('vw_life_coach_phone_number') != ''){ ?>
          <p class="py-2 py-lg-3 py-md-3 mb-0"><i class="fas fa-phone mr-2"></i><?php echo esc_html(get_theme_mod('vw_life_coach_phone_text',''));?>: <a href="tel:<?php echo esc_url( get_theme_mod('vw_life_coach_phone_number','') ); ?>"><?php echo esc_html(get_theme_mod('vw_life_coach_phone_number',''));?></a></p>
        <?php } ?>
      </div>
      <div class="col-lg-2 col-md-2">
